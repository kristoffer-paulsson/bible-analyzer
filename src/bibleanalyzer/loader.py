...
class LoaderIterator(collections.abc.Iterator):
...
class FreshLoaderIterator(LoaderIterator):

    def __init__(self, filename: Path, translation: str):
        LoaderIterator.__init__(self, translation)
...
class PickleLoaderIterator(LoaderIterator):

    def __init__(self, data: list, translation: str):
        LoaderIterator.__init__(self, translation)
        self._entries = data
