...
NORMALIZE = {
    'Ͱ': "Ͱ", 'ͱ': "ͱ", 'Ͳ': "Ϡ", 'ͳ': "ϡ", 'ʹ': "ʹ", '͵': "͵", 'Ͷ': "Ϝ", 'ͷ': "ϝ", 'ͺ': "ͺ",
    'ͻ': "σ", 'ͼ': "σ", 'ͽ': "σ", ';': ";", 'Ϳ': "Ϳ", '΄': "΄", '΅': "΅", 'Ά': "Α", '·': "·",
    'Έ': "Ε", 'Ή': "Η", 'Ί': "Ι", 'Ό': "Ο", 'Ύ': "Υ", 'Ώ': "Ω", 'ΐ': "ι", 'Α': "Α", 'Β': "Β",
    'Γ': "Γ", 'Δ': "Δ", 'Ε': "Ε", 'Ζ': "Ζ", 'Η': "Η", 'Θ': "Θ", 'Ι': "Ι", 'Κ': "Κ", 'Λ': "Λ",
    'Μ': "Μ", 'Ν': "Ν", 'Ξ': "Ξ", 'Ο': "Ο", 'Π': "Π", 'Ρ': "Ρ", 'Σ': "Σ", 'Τ': "Τ", 'Υ': "Υ",
    'Φ': "Φ", 'Χ': "Χ", 'Ψ': "Ψ", 'Ω': "Ω", 'Ϊ': "Ι", 'Ϋ': "Υ", 'ά': "α", 'έ': "ε", 'ή': "η",
    'ί': "ι", 'ΰ': "υ", 'α': "α", 'β': "β", 'γ': "γ", 'δ': "δ", 'ε': "ε", 'ζ': "ζ", 'η': "η",
    'θ': "θ", 'ι': "ι", 'κ': "κ", 'λ': "λ", 'μ': "μ", 'ν': "ν", 'ξ': "ξ", 'ο': "ο", 'π': "π",
    'ρ': "ρ", 'ς': "ς", 'σ': "σ", 'τ': "τ", 'υ': "υ", 'φ': "φ", 'χ': "χ", 'ψ': "ψ", 'ω': "ω",
    'ϊ': "ι", 'ϋ': "υ", 'ό': "ο", 'ύ': "υ", 'ώ': "ω", 'Ϗ': "και", 'ϐ': "Β", 'ϑ': "Θ", 'ϒ': "Υ",
    'ϓ': "Υ", 'ϔ': "Υ", 'ϕ': "Φ", 'ϖ': "Π", 'ϗ': "και", 'Ϙ': "Ϟ", 'ϙ': "ϟ", 'Ϛ': "Ϛ", 'ϛ': "ϛ",
    'Ϝ': "Ϝ", 'ϝ': "ϝ", 'Ϟ': "Ϟ", 'ϟ': "ϟ", 'Ϡ': "Ϡ", 'ϡ': "ϡ", 'Ϣ': "Ϣ", 'ϣ': "ϣ", 'Ϥ': "Ϥ",
    'ϥ': "ϥ", 'Ϧ': "Ϧ", 'ϧ': "ϧ", 'Ϩ': "Ϩ", 'ϩ': "ϩ", 'Ϫ': "Ϫ", 'ϫ': "ϫ", 'Ϭ': "Ϭ", 'ϭ': "ϭ",
    'Ϯ': "Ϯ", 'ϯ': "ϯ", 'ϰ': "Κ", 'ϱ': "ρ", 'ϲ': "σ", 'ϳ': "ϳ", 'ϴ': "Θ", 'ϵ': "ε", '϶': "ε",
    'Ϸ': "Ϸ", 'ϸ': "ϸ", 'Ϲ': "Σ", 'Ϻ': "Ϻ", 'ϻ': "ϻ", 'ϼ': "ρ", 'Ͻ': "Σ", 'Ͼ': "Σ", 'Ͽ': "Σ",
    'ἀ': "α", 'ἁ': "α", 'ἂ': "α", 'ἃ': "α", 'ἄ': "α", 'ἅ': "α", 'ἆ': "α", 'ἇ': "α", 'Ἀ': "Α",
    'Ἁ': "Α", 'Ἂ': "Α", 'Ἃ': "Α", 'Ἄ': "Α", 'Ἅ': "Α", 'Ἆ': "Α", 'Ἇ': "Α", 'ἐ': "ε", 'ἑ': "ε",
    'ἒ': "ε", 'ἓ': "ε", 'ἔ': "ε", 'ἕ': "ε", 'Ἐ': "Ε", 'Ἑ': "Ε", 'Ἒ': "Ε", 'Ἓ': "Ε", 'Ἔ': "Ε",
    'Ἕ': "Ε", 'ἠ': "η", 'ἡ': "η", 'ἢ': "η", 'ἣ': "η", 'ἤ': "η", 'ἥ': "η", 'ἦ': "η", 'ἧ': "η",
    'Ἠ': "Η", 'Ἡ': "Η", 'Ἢ': "Η", 'Ἣ': "Η", 'Ἤ': "Η", 'Ἥ': "Η", 'Ἦ': "Η", 'Ἧ': "Η", 'ἰ': "ι",
    'ἱ': "ι", 'ἲ': "ι", 'ἳ': "ι", 'ἴ': "ι", 'ἵ': "ι", 'ἶ': "ι", 'ἷ': "ι", 'Ἰ': "Ι", 'Ἱ': "Ι",
    'Ἲ': "Ι", 'Ἳ': "Ι", 'Ἴ': "Ι", 'Ἵ': "Ι", 'Ἶ': "Ι", 'Ἷ': "Ι", 'ὀ': "ο", 'ὁ': "ο", 'ὂ': "ο",
    'ὃ': "ο", 'ὄ': "ο", 'ὅ': "ο", 'Ὀ': "Ο", 'Ὁ': "Ο", 'Ὂ': "Ο", 'Ὃ': "Ο", 'Ὄ': "Ο", 'Ὅ': "Ο",
    'ὐ': "υ", 'ὑ': "υ", 'ὒ': "υ", 'ὓ': "υ", 'ὔ': "υ", 'ὕ': "υ", 'ὖ': "υ", 'ὗ': "υ", 'Ὑ': "Υ",
    'Ὓ': "Υ", 'Ὕ': "Υ", 'Ὗ': "Υ", 'ὠ': "ω", 'ὡ': "ω", 'ὢ': "ω", 'ὣ': "ω", 'ὤ': "ω", 'ὥ': "ω",
    'ὦ': "ω", 'ὧ': "ω", 'Ὠ': "Ω", 'Ὡ': "Ω", 'Ὢ': "Ω", 'Ὣ': "Ω", 'Ὤ': "Ω", 'Ὥ': "Ω", 'Ὦ': "Ω",
    'Ὧ': "Ω", 'ὰ': "α", 'ά': "α", 'ὲ': "ε", 'έ': "ε", 'ὴ': "η", 'ή': "η", 'ὶ': "ι", 'ί': "ι",
    'ὸ': "ο", 'ό': "ο", 'ὺ': "υ", 'ύ': "υ", 'ὼ': "ω", 'ώ': "ω", 'ᾰ': "α", 'ᾱ': "α", 'ᾶ': "α",
    'Ᾰ': "Α", 'Ᾱ': "Α", 'Ὰ': "Α", 'Ά': "Α", '᾽': "᾽", 'ι': "ι", '᾿': "᾿", '῀': "῀", '῁': "῁",
    'ῆ': "η", 'Ὲ': "Ε", 'Έ': "Ε", 'Ὴ': "Η", 'Ή': "Η", '῍': "῍", '῎': "῎", '῏': "῏", 'ῐ': "ι",
    'ῑ': "ι", 'ῒ': "ι", 'ΐ': "ι", 'ῖ': "ι", 'ῗ': "ι", 'Ῐ': "Ι", 'Ῑ': "Ι", 'Ὶ': "Ι", 'Ί': "Ι",
    '῝': "῝", '῞': "῞", '῟': "῟", 'ῠ': "υ", 'ῡ': "υ", 'ῢ': "υ", 'ΰ': "υ", 'ῤ': "ρ", 'ῥ': "ρ",
    'ῦ': "υ", 'ῧ': "υ", 'Ῠ': "Υ", 'Ῡ': "Υ", 'Ὺ': "Υ", 'Ύ': "Υ", 'Ῥ': "Ρ", '῭': "῭", '΅': "΅",
...
EXPAND = {
    ...
    'ᾞ': "Ἦι", 'ᾟ': "Ἧι", 'ᾠ': "ιὠ", 'ᾡ': "ὡι", 'ᾢ': "ὢι", 'ᾣ': "ὣι", 'ᾤ': "ιὤ", 'ᾥ': "ὥι", 'ᾦ': "ὦι", 'ᾧ': "ὧι",
...
class Koine:
    ...
    def expand(cls, word: str) -> str:
        ...
        for char in bits:
            normal += EXPAND[char] if char in EXPAND.keys() else char
